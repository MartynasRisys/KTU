...
object ControlFunction
{
    ...
    def analyzeViewAsMaster(bot: Bot) = {
        ...
        if (!dest.isDefined) 
        {
            ...
            var found = false
            while(!found) {
                for (i <- xOffsetLeft + xOffsetRight until n) {
                    bot.log(cellDetails(yOffsetTop)(i).toString)
                ...
                if (!found)
                {
                  for (i <- yOffsetTop + yOffsetBot until n) {
                    bot.log(cellDetails(i)(n - 1 - xOffsetRight).toString)
                ...
                if (!found)
                {
                  ...
                  for (i <- xOffsetRight + xOffsetLeft until n) {
                    bot.log(cellDetails(n - 1 - yOffsetBot)(iterator).toString)
                ...
                if (!found)
                {
                  ...
                  for (i <- yOffsetBot + yOffsetTop until n) {
                    bot.log(cellDetails(iterator)(n - 1 - xOffsetLeft).toString)
                    if (cellDetails(iterator)(n - 1 - xOffsetLeft).f == 100)
                    {
                        //found = true
                    }
                    iterator -= 1
        ...
        while(!openList.isEmpty) {
            ...
            var hNew = 0.0
            var fNew = 0.0
            if (XY.isValid(currentCOL-1, currentROW) == true && !foundDest)
            {
            ...
            if (XY.isValid(currentCOL, currentROW+1) == true && !foundDest)
            {
            ...
            if (XY.isValid(currentCOL-1, currentROW+1) == true && !foundDest)
            {
