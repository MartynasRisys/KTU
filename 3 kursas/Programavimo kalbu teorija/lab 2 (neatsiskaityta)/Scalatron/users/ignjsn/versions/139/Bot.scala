    ...
    def analyzeViewAsMaster(bot: Bot) = {
        ...
        while(!openList.isEmpty) {
            ...
            if (XY.isValid(currentCOL, currentROW+1) == true)
            {
                ...
                { 
                    gNew = cellDetails(currentCOL)(currentROW).g + 1
            ...
            if (XY.isValid(currentCOL-1, currentROW+1) == true)
            {
                ...
                { 
                    gNew = cellDetails(currentCOL)(currentROW).g + 1.444
...
object XY {
    ...
    def calculateHValue(row: Int, col: Row, dest: XY) 
    { 
